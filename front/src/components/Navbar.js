...
export const Navbar = () => {
  ...
  return (
    <>
    <img className="absolute max-md:hidden 
    md:left-[2%] md:w-[18%] md:top-[9%] 
    lg:left-[2%] lg:w-[13%] lg:top-[9%] 
    xl:left-[2%] xl:w-[11%] xl:top-[9%]" src={Vector} alt="title" />

    <div className="z-20 absolute  w-full h-20 bottom-0 bg-gray-700 rounded-t-3xl
    ...
    xl:bg-transparent xl:w-[14%] xl:top-[25%] xl:flex xl:flex-col xl:h-[75%]">
      ...
      <div className="absolute top-6 space-x-16 left-[10%] 
      ...
      xl:flex xl:flex-col xl:space-y-20 xl:left-[0%]">
        ...
        <div className="md:flex lg:flex xl:flex">
          ...
          xl:text-gray-700 xl:pr-44 xl:left-[5%] xl:w-64 xl:pl-3 xl:hover:bg-gray-700 xl:hover:text-[#bfd732] xl:pt-5 xl:pb-5 xl:-top-6">
            <FiUsers size={38} />
          <p className="max-md:hidden absolute
          md:top-6 md:left-[29%] md:font-semibold
          lg:top-6 lg:left-[29%] lg:font-semibold
          xl:top-6 xl:left-[29%] xl:font-semibold">Users</p>
          </button>
          </Link>
        </div>
        ...
        <div className="md:flex lg:flex xl:flex ">
          ...
          xl:top-7 xl:left-[29%] xl:font-semibold">Stadistics</p>
          </button>
          </Link>
        </div>
        ...
        <div className="md:flex lg:flex xl:flex">
          ...
          md:top-7 md:left-[29%] md:font-semibold
          lg:top-7 lg:left-[29%] lg:font-semibold
          xl:top-7 xl:left-[29%] xl:font-semibold">Reports</p>
          </button>
          </Link>
        </div>
        <div className="md:flex lg:flex xl:flex">
          ...
          md:top-7 md:left-[29%] md:font-semibold 
          lg:top-7 lg:left-[29%] lg:font-semibold 
          xl:top-7 xl:left-[29%] xl:font-semibold">Profile</p>
          </button>
        </div>
        <div className="md:flex lg:flex xl:flex">
          <button
          ...
          md:top-6 md:left-[29%] md:font-semibold
          lg:top-6 lg:left-[29%] lg:font-semibold
          xl:top-6 xl:left-[29%] xl:font-semibold">Log out</p>
          </button>
        </div>
      </div>
    </div>
