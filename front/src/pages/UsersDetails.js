...
const UsersDetails = () => {
  ...
  const nameAndLastname = userDetail.name + " " + userDetail.lastname;
      ...
      >
        ...
        >
          ...
          <div className=" z-10 absolute bg-white shadow shadow-slate-500 left-[3%] top-[20%] rounded-3xl w-[94%] h-[75%]">
            ...
            <div className="absolute container w-full h-[85%] border border-solid bg-white shadow shadow-slate-500 
            lg:top-[6%]
            "
            >
            ...
            <div className="container absolute mx-auto h-[95%]  
            sm:h-[88%] sm:left-2
            md:h-[88%] md:left-2
            ...
            ">
              <div className="relative space-y-2 flex flex-col">
                ...
                <div className="relative  text-gray-700 
                  ...
                  {userDetail.language || "No language added"}
                </div>
                <div
                  ...
                  {userDetail?.skill || "No skills added"}
                </div>
              </div>
              <div
                className="relative bg-gray-100 
            ...
            xl:rounded-b-3xl xl:w-full xl:top-[23%] xl:h-[10%] xl:-left-2
            2xl:rounded-b-3xl 2xl:w-full 2xl:top-[19%] 2xl:h-[10%] 2xl:-left-2
            "
              />
            </div>
          </div>
